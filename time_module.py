...
time.strftime("%B %d %Y %H:%M:%S", time_object)  # formats a time_object to a string
# time_object = time.localtime()    # local time
...
time.strptime(time_string, "%d %B, %Y")  # parses a string representing time/date and returns a struct_time object
